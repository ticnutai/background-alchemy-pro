    ...
    <div className="min-h-screen bg-background font-body" dir="rtl">
        ...
        <div className="bg-background py-16">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 text-center">
            ...
            <div className="mt-8 flex flex-col sm:flex-row justify-center gap-4">
              <a
                href="#contact"
                className="rounded-full bg-gold px-6 py-3 sm:px-8 sm:py-3.5 font-display text-sm font-semibold text-gold-foreground transition-all hover:brightness-110"
              >
                צור קשר
              </a>
              <a
                href="#gallery"
                className="rounded-full border border-border bg-card px-6 py-3 sm:px-8 sm:py-3.5 font-display text-sm font-semibold text-foreground transition-all hover:border-gold/40"
              >
                צפה בעבודות
              </a>
            </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              ...
              />
              <div className="absolute -bottom-6 -right-6 h-48 w-48 rounded-2xl border-4 border-card overflow-hidden shadow-xl">
      ...
      <section id="services" className="py-16 sm:py-24 bg-card">
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          ...
          {/* CTA to tool */}
          <div className="mt-16 rounded-2xl bg-gradient-to-r from-gold/20 via-gold/10 to-transparent border border-gold/20 p-6 sm:p-10 flex flex-col sm:flex-row items-center justify-between gap-4">
            <div>
